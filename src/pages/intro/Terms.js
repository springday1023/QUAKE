            ...
            <main className="content"> 
                ...
                <div className="content-wrap">
                    <div className="page-infobox">
                        <section>
                            <h3 className="title">KIGAM Quake 이용약관</h3>
                            <ul>
                        ...
                        <section>
                            <h3 className="title">한국지질자원연구원 지오빅데이터 오픈플랫폼 저작권정책</h3>
                            <ul>
                        ...
                        <section>
                            <h3 className="title">한국지질자원연구원 지오빅데이터 오픈플랫폼 저작권정책</h3>
                            <p>
                                한국지질자원연구원은 제공데이터의 정확성, 완전성(데이터에 하자 내지 결함이 없음), 안전성(데이터에 바이러스 등 악성코드가 없음), 유효성(본 계약 목적에의 적합성)을 보증하지 않는다. 
                                한국지질자원연구원은 제공데이터가 타인의 지식재산권 및 기타 권리를 침해하지 않는다는 것을 보증하지 아니한다. 
                                한국지질자원연구원은 데이터 이용자가 제공데이터를 이용하는 과정에서 발생한 타인의 발명 고안 창작 및 영업비밀 등 지식재산권 및 기타 권리 침해에 관한 모든 청구 손실 손해 또는 비용에 대하여 책임을 지지 않는다. 
                            </p>
                            <p>
                                데이터 이용자는 제공데이터 이용에 관련되는 제3자와의 사이에 분쟁 클레임 또는 청구(이하 [분쟁 등]이라 한다)가 발생한 경우에는 즉시 한국지질자원연구원에 서면으로 통지하여야 하고 또한 자기의 책임과 비용 부담으로 해당 분쟁 등을 해결한다.
                            </p>
                        </section>
                    </div>
                </div>
