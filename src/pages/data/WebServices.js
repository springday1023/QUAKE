            ...
            <main className="content">
                ...
                <section className="content-wrap">
                    <div className="page-infobox">
                        <section>
                            <h3 className="title">FDSN Web Services란?</h3>
                        ...
                        <section>
                            <h3 className="title">KIGAM Quake FDSN Web Services</h3>
                            <ul className="list_dot">
                        ...
                        <section>
                            <h3 className="title">ObsPy를 이용한 KIGAM Quake FDSN Web Services 이용 방법</h3>
