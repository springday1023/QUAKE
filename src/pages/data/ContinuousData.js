        ...
        <>
            ...
            <main className="content">
                ...
                <section className="content-wrap"> 
                    ...
                    <p className="text-notice"><span>?</span>관측소(채널) 단위의 연속파형자료 검색 및 다운로드 기능을 제공합니다.</p>
                    
                    <table className="table-view table-view--topline" summary="연속파형자료 조회 조건 선택">
                        <colgroup>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div className="formbox">
                                        <label className="radio"><input type="radio" name="magnitude" /><span>전체</span></label>
                                    </div>  
                                    <div className="formbox">
                                        <span className="formbox__col">
                                            <label className="radio"><input type="radio" name="magnitude" /><span>조건 설정</span></label>
                                        </span>
                                        <ul className="formbox__setting">
                                            <li>
                                                <span className="col">Sample Rate:</span>
                                                <span className="col"><label className="checkbox"><input type="checkbox" name="selectorType" /><span>20 sps</span></label></span>
                                                <span className="col"><label className="checkbox"><input type="checkbox" name="selectorType" /><span>100 sps</span></label></span> 
                                            </li>
                                            <li>
                                                <span className="col">설치 위치:</span>
                                                <span className="col"><label className="checkbox"><input type="checkbox" name="selectorType" /><span>지표면</span></label></span>
                                                <span className="col"><label className="checkbox"><input type="checkbox" name="selectorType" /><span>시추공</span></label></span> 
                                            </li>
                                            <li>
                                                <span className="col">센서 종류:</span>
                                                <span className="col"><label className="checkbox"><input type="checkbox" name="selectorType" /><span>속도(단주기)</span></label></span>
                                                <span className="col"><label className="checkbox"><input type="checkbox" name="selectorType" /><span>속도(광대역)</span></label></span> 
                                                <span className="col"><label className="checkbox"><input type="checkbox" name="selectorType" /><span>가속도</span></label></span> 
                                            </li>
                                        </ul>
                                    </div>  
                                    <div className="formbox">
                                        <label className="radio"><input type="radio" name="magnitude" /><span>직접입력</span></label>
                                        <input type="text" className="entry" style={{"width":"150px"}} placeholder="HG?, HA?" />
                                    </div>  
                                    <div className="formbox">
                                        <button type="button" className="button-medium" onClick={openModal}>선택 채널 목록 보기</button>
                                    </div>
                                </td> 
                            </tr> 
                            <tr>
...
2022-01-01 10:00:00.000" className="entry date" placeholder="2022-01-01 10:00:00" />
                                    ...
                                    <div className="formbox">
                                        <span class="formbox__label">Timezone: </span>
                                        <label class="radio"><input type="radio" name="timezone" /><span>KST</span></label>                                        
                                        <label class="radio"><input type="radio" name="timezone" /><span>UTC</span></label>                                        
                                    </div>

                                    <p className="text-caution"><span>!</span>2016년 이후 자료를 서비스하고 있으며, 신규 자료는 1~2일 이후에 다운로드 할 수 있습니다.</p>
                                    <p className="text-caution"><span>!</span>한번에 최대 3일 자료를 다운로드 할 수 있습니다.</p>
                                    <p className="text-caution"><span>!</span>많은 자료를 한 번에 요청할 경우 로딩시간이 길어집니다. (브라우저 내부적으로 다운로드가 완료된 후 파일 다운로드가 시작됩니다.)</p>
                                    <p className="text-caution"><span>!</span>좀 더 다양한 조건으로 기간 제한 없이 다운로드를 받고 싶으시면 <a href="/quake/openapi/fdsnws">Web Services(FDSNWS)</a>를 이용 부탁드립니다.</p>
                                    <div className="formbox">
                                        <button type="button" className="button-medium" onClick={openModal2}>가용률 보기</button>
                                    </div>
                                </td> 
                            </tr>  
                        </tbody>
                    ...
                    <section className="databox">
                        <h4 className="title">자료 형식</h4>
                        <ul>
                            <li><label className="radio"><input type="radio" name="selectorType" /><span>miniSEED</span></label></li>
                            <li><label className="radio"><input type="radio" name="selectorType" /><span>SAC</span></label></li>
                            <li><label className="radio"><input type="radio" name="selectorType" /><span>GeoCSV (ASCII)</span></label></li>
                        </ul>
                    </section>
                    <section className="databox">
            ...
            <div className={ isShown2 ? 'modal-popup modal-popup--show' : 'modal-popup'}>
                <section className="modal-popup__inner">
                    ...
                    <div className="modal-popup__cont">
                        <div className="table-head">
                            <p>총 0건</p> 
                            <p className="table-head__rtl">(초록색: ≥ 98%, 주황색: ≥ 90%, 빨간색: &gt; 90%, 회색: 0%)</p>
                        </div>
                                    ...
                                    <tr> 
                                        ...
                                        <th>
                                            ...
                                            <span className="tooltip">
                                                <button type="button" className="text-notice"><span>?</span></button>
                                                <div className="tooltip__cont">
