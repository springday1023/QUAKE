        ...
        <>
            ...
            <main className="content">
                ...
                <section className="content-wrap"> 
                    ...
                    <p className="text-notice"><span>?</span>K-ESM (KIGAM Engineering Strong Motion) DB는 관측소 단위의 가속도 관측기록의 검색, 가공 및 다운로드 기능을 제공합니다.</p>
                    
                    <table className="table-view table-view--topline" summary="K-ESM DB 조회 조건">
                        <colgroup>
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">
                                    이벤트 
                                    <span className="text-quote">기상청 국내지진 목록에 기반함</span>
                                </th>
                                <td>
                                    <div className="formbox">
                                        <span className="formbox__col">
                                            <label className="checkbox"><input type="checkbox" name="period" /><span>기간</span></label> 
                                        </span>
                                        <span className="formbox__col">
                                    ...
                                    <div className="formbox">
                                        <span className="formbox__col">
                                            <label className="checkbox"><input type="checkbox" name="period" /><span>규모</span></label> 
                                        </span>
                                        <span className="formbox__col">
                                    ...
                                    <div className="formbox"> 
                                        <span className="formbox__col">
                                            <label className="checkbox"><input type="checkbox" name="magnitude" /><span>위치</span></label>
                                        </span>
                                        <div className="formbox__col">
                                            <div className="formbox"> 
                                                <span className="formbox__col">
                                                    ...
                                                    <input type="text" className="entry" placeholder="35" /> ~ 
                                                    <input type="text" className="entry" placeholder="38" />
                                                </span>
                                                <span className="formbox__col">
                                    ...
                                    <div className="formbox">
                                        <span className="formbox__col">
                                            <label className="checkbox"><input type="checkbox" name="period" /><span>진원 깊이(km)</span></label>
                                        </span>
                                        <span className="formbox__col">
                            ...
                            <tr>
                                ...
                                <td> 
                                    <div className="formbox"> 
                                        <span className="formbox__col">
                                            <label className="radio"><input type="radio" name="period" /><span>조건 설정</span></label>
                                        </span>
                                        <div className="formbox__row"> 
                                        <span className="formbox__col">
                                            <label className="checkbox checkbox__noshow"><input type="checkbox" name="" checked /><span>위치</span></label>
                                        </span>
                                        <div className="formbox__col">
                                            <div className="formbox"> 
                                                <span className="formbox__col">
                                    ...
                                    <div className="formbox">
                                        <span className="formbox__col">
                                            <label className="radio"><input type="radio" name="selectorType" /><span>직접 선택</span></label>
                                            <span className="btn">
                            ...
                            <tr>
                                <th scope="row">
                                    관측 기록 
                                    <span className="text-quote">1 g ≈ 981 cm/s2</span>
                                </th>
                                <td> 
                                    <div className="formbox">
                                        <label className="checkbox"><input type="checkbox" name="period" /><span>진앙 거리(km)</span></label> 
                                        <span className="formbox__col">
                                            <input type="text" className="entry" placeholder="0" /> ~ <input type="text" className="entry" placeholder="30" />
                                        </span>
                                    </div>  
                                    <div className="formbox">
                                        <label className="checkbox"><input type="checkbox" name="period" /><span>수평방향 PGA (cm/s<sup>2</sup>)</span></label> 
                                        <span className="formbox__col">
                                            <input type="text" className="entry" placeholder="0" /> ~ <input type="text" className="entry" placeholder="30" />
                                        </span>
                                    </div>  
                                    <div className="formbox">
                                        <label className="checkbox"><input type="checkbox" name="period" /><span>수직방향 PGA (cm/s<sup>2</sup>)</span></label> 
                                        <span className="formbox__col">
                                            <input type="text" className="entry" placeholder="0" /> ~ <input type="text" className="entry" placeholder="30" />
                                        </span>
                                    </div>  
                                    <div className="formbox">
                                        <label className="checkbox"><input type="checkbox" name="period" /><span>센서 설치 유형:</span></label> 
                                        <span className="formbox__col">
                                            <label className="radio"><input type="radio" name="selectorType" /><span>지표형</span></label>
                                            <label className="radio"><input type="radio" name="selectorType" /><span>시추형</span></label>
                                        </span>
                                    </div>  
                    ...
                    <div className="table-list table-list--line table--scroll">
                        <table summary="K-ESM 목록">
                            ...
                            <thead>
                                ...
                                <tr>
                                    <th scope="col"><label className="checkbox"><input type="checkbox" name="period" /><span className="hidden">선택</span></label></th>
                            ...
                            <tbody>
                                <tr>
                                    <td onClick={openModal2}><label className="checkbox"><input type="checkbox" name="period" /><span className="hidden">선택</span></label></td>
                    ...
                    <p className="text-caution"><span>i</span>본 가공자료에 일괄 적용된 신호처리 기법은 <a href="https://kr.object.gov-ncloudstorage.com/kerc-kquake-public/manuals/K_EMS_DB_manual_latest.pdf" target="_blank" rel="noreferrer">매뉴얼</a>을 참고하세요. 위 표의 개별 신호처리 버튼을 클릭하시면 사용자가 원하는 신호처리 파라미터를 설정하고 다운로드 할 수 있습니다.</p>
                    
                    <div className="databox">
                        <h4 className="title">데이터</h4>
                        <div>
                            <ul>
                                <li><label className="radio"><input type="radio" name="selectorType" /><span>가공자료 (ASCII)</span></label></li>
                                <li><label className="radio"><input type="radio" name="selectorType" /><span>원시자료 (miniSEED)</span></label></li> 
                            </ul>
                            <ul>
                                <li><label className="checkbox"><input type="checkbox" name="selectorType" /><span>가속도</span></label></li>
                                <li><label className="checkbox"><input type="checkbox" name="selectorType" /><span>속도</span></label></li>
                                <li><label className="checkbox"><input type="checkbox" name="selectorType" /><span>변위</span></label></li>
                                <li><label className="checkbox"><input type="checkbox" name="selectorType" /><span>가속도 응답 스펙트럼</span></label></li>
                            </ul>
                        </div>
                    </div>
                    
                    <div className="databox">
                        <h4 className="title">활용 목적</h4>
                        <ul>
                            <li><label className="radio"><input type="radio" name="selectorType" /><span>연구(자연과학)</span></label></li>
                            <li><label className="radio"><input type="radio" name="selectorType" /><span>연구(공학)</span></label></li>
                            <li><label className="radio"><input type="radio" name="selectorType" /><span>설계</span></label></li>
                            <li><label className="radio"><input type="radio" name="selectorType" /><span>교육</span></label></li>
                            <li><label className="radio"><input type="radio" name="selectorType" /><span>기타</span></label></li>
                        </ul>
                    </div>
                    
                    <p className="text-agree">
                        <label className="checkbox"><input type="checkbox" name="selectorType" /><span>지진전문연구정보 서비스의 <Link target="_blank" rel="noreferrer" href="/intro/terms">이용약관</Link>을 확인하였으며, 이에 동의합니다.</span></label>
                    </p>
                    <div className="button-area">
            ...
            <div className={ isShown ? 'modal-popup modal-popup--show' : 'modal-popup'}> 
                <section className="modal-popup__inner">
                    ...
                    <div className="modal-popup__cont">
                        <div className="report-box">
                            <div className="report-box__opt">
                                <section className="box">
                                    <h3>1. Time window</h3>
                                    <div className="box__row">
                                        <span className="label">At the beginning (s)</span> 
                                        <input type="number" /> 
                                    </div>
                                    <div className="box__row">
                                        <span className="label">At the end (s)</span> 
                                        <input type="number" />
                                    </div>
                                </section>
                                ...
                                <section className="box">
                                    ...
                                    <div className="box__row">
                                        <label className="checkbox"><input type="checkbox" name="period" /><span>At the beginning (%)</span></label> 
                                        <input type="number" />
                                    </div>
                                    <div className="box__row">
                                        <label className="checkbox"><input type="checkbox" name="period" /><span>At the end (%)</span></label> 
                                        <input type="number" />
                                    </div>
                                </section>
                                ...
                                <section className="box">
                                    ...
                                    <div className="box__row">
                                        <label className="checkbox"><input type="checkbox" name="period" /><span>Low-cut (Hz)</span></label> 
                                        <input type="number" />
                                    </div>
                                    <div className="box__row">
                                        <label className="checkbox"><input type="checkbox" name="period" /><span>High-cut (Hz)</span></label> 
                                        <input type="number" />
                                    </div>
                                    <div className="box__row">
                                        <span className="label">Filter order</span>
                                        <select>
                                ...
                                <section className="box">
                                    <h3>※ 활용 목적</h3>
                                    <div className="box__row">
                                        <label className="radio"><input type="radio" name="period" /><span>연구(자연과학)</span></label> 
                                        <label className="radio"><input type="radio" name="period" /><span>연구(공학)</span></label> 
                                        <label className="radio"><input type="radio" name="period" /><span>설계</span></label> 
                                        <label className="radio"><input type="radio" name="period" /><span>교육</span></label> 
                                        <label className="radio"><input type="radio" name="period" /><span>기타</span></label> 
                                    </div>
                                </section> 
                                <div className="button-area">
                                    <Link to="/" className="button-big">실행</Link>
                                </div>
                            </div>

                            <div className="report-box__data">
                                <section className="box">
                                    <h3>Select data type</h3>
                                    <div className="box__row">
                                        <label className="radio"><input type="radio" name="period" /><span>ACC</span></label> 
                                        <label className="radio"><input type="radio" name="period" /><span>VEL</span></label> 
                                        <label className="radio"><input type="radio" name="period" /><span>DISP</span></label> 
                                        <label className="radio"><input type="radio" name="period" /><span>ACC_SPECTRA</span></label> 
                                    </div>
                                </section>
                                <section className="box">그래프</section>
            ...
            {/* Popup */}
            <div className={ isShown2 ? 'modal-popup modal-popup--show' : 'modal-popup'}> 
                <section className="modal-popup__inner">
                    <h2>파형 미리보기</h2> 
                    <div className="modal-popup__cont">
                        그래프
                    </div>
                    <button type="button" className="modal-popup__close" onClick={openModal2}><span>닫기</span></button>
                </section>
            </div>
