                    ...
                    <table className="table_view bdt2" summary="메타데이터 검색 조건">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div className="form_box">
                                        <label className="radio_01"><input type="radio" name="dataType" /><span>StationXML</span></label>
                                        <label className="radio_01"><input type="radio" name="dataType" /><span>SACPZ</span></label> 
                                    </div> 
                                    <p className="text_update"><span>!</span> 메타데이터 업데이트: 2023-04-27</p>
                                </td> 
                            </tr> 
                        </tbody>
                    </table>
